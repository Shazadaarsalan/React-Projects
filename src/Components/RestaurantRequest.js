...
async fetchData() {
    ...
    try {
        ...
        var orderAgyaHai = await GetOrder(); 
       
        console.log("fetchData >>>>>>2",orderAgyaHai);
        this.DisplayData(orderAgyaHai)
...
<button className="ResButton" onClick={''}><h2 className="h2">Pending</h2></button>
</div>
...
<div class="div1">
<img src="https://kfoods.com/images1/newrecipeicon/BarBQ-Seekh-Kabab_9963.jpg" class="Resimage" alt="logo"/>
</div>
<hr></hr>
...
<div class="div3"><button className="ResButton"><h2 className="h2">Pending</h2></button>
</div>
...
<div class="div1">
<img src="https://img1.wsimg.com/isteam/stock/2999" class="Resimage"  alt="logo"/>
</div>
<hr></hr>
